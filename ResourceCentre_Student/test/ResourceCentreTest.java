...
public class ResourceCentreTest {
	...
	public void doLoanCamcorderTest() {
		...
		ResourceCentre.addCamcorder(camcorderList, cc1);
		boolean op01 = ResourceCentre.doLoanCamcorder(camcorderList, "CC0011", "25-7-2020");
	...
	public void doLoanChromebookTest() {
		...
		//After the CC001 in camcorderList is loaned with a due date of 10, the due date changed
		ResourceCentre.addChromebook(chromebookList, cb1);
		boolean op01 = ResourceCentre.doLoanChromebook(chromebookList, "CB0011", "25-7-2020");
		assertEquals(true, op01);
